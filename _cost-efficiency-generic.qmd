...
::::: {.chart-container}  
`r if (params$country == rp_full & cztype == "enroute") ":::::: {.content-hidden}"`
```{r chart_cef_duc, options = (cz=c("@@cz_index@@", "@@cz_type@@","level2"))}
#| file: R/chart_level1_cef.R
#| out.width: "100%"
```
`r if (params$country == rp_full & cztype == "enroute") "::::::"`

`r if (params$country != rp_full | cztype == "terminal") ":::::: {.content-hidden}"`
```{r chart_cef_duc_er_ses, options = (cz=c("@@cz_index@@", "@@cz_type@@")), eval=(params$country == rp_full)}
#| file: R/chart_level1_cef_er_ses.R
#| out.width: "100%"
```
`r if (params$country != rp_full | cztype == "terminal") "::::::"`
