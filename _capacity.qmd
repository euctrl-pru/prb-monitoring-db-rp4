...
`r if (params$country == rp_full | params$country == "MUAC") "::: {.content-hidden}"`
...
:::
`r if (params$country == rp_full | params$country == "MUAC") ":::"`
...
```{r table-cap-apt-pis, eval=!(params$no_tcz == 0 | params$country == rp_full)}
