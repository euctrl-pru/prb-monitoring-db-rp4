...
`r if (params$country == rp_full | params$no_saf_ansps == 1) ":::: {.content-hidden}"`
::::: {layout="[ 50, 50 ]"}
...
:::::: {.chart-container}  
```{r, eval = (params$country != rp_full) & (params$no_saf_ansps > 1)}
#| echo: false
mycharts[[2]]
```
:::::: 
:::::
`r if (params$country == rp_full | params$no_saf_ansps == 1) "::::"`


`r if (params$country == rp_full | params$no_saf_ansps != 3) ":::: {.content-hidden}"`
::::: {layout="[ 25, 50, 25 ]"}
...
:::::: {.chart-container}  
```{r, eval = (params$country != rp_full) & (params$no_saf_ansps > 2)}
#| echo: false
mycharts[[3]]
```
:::::: 
...
:::::: 
:::::
`r if (params$country == rp_full | params$no_saf_ansps != 3) "::::"`


`r if (params$country == rp_full | params$no_saf_ansps != 4) ":::: {.content-hidden}"`
::::: {layout="[ 50, 50 ]"}
...
:::::: {.chart-container}  
```{r, eval = (params$country != rp_full) & (params$no_saf_ansps > 3)}
#| echo: false
mycharts[[4]]
```
:::::: 
:::::
`r if (params$country == rp_full | params$no_saf_ansps != 4) "::::"`


`r if (params$country != rp_full) ":::: {.content-hidden}"`
::::: {layout="[ 50, 50 ]"}
:::::: {.chart-container}  
```{r chart_level2_saf_eosm_target_ses, eval = params$country == rp_full}
...
:::::: {.chart-container}  
```{r chart_saf_ansp_ses, eval = params$country == rp_full}
...
```{r chart_level2_saf_eosm_ses_allstates, eval= params$country == rp_full}
...
:::::: {.chart-container}  
```{r chart_level2_saf_eosm_count_ses, eval= params$country == rp_full}
...
:::::: {.chart-container}  
```{r chart_level2_saf_maturity_count_ses, eval= params$country == rp_full}
...
`r if (params$country != rp_full) ":::: {.content-hidden}"`
```{r chart_level2_saf_ri_per_state_ses, eval= (params$country == rp_full)}
#| file: R/chart_level2_saf_ri_per_state_ses.R
#| out.width: "100%"
```

```{r table_level2_saf_ri_apt_ses, eval= (params$country == rp_full)}
...
::::: {.chart-container}  
```{r table_level2_saf_ri_apt, eval= (params$country != "MUAC") & (params$country != rp_full)}
...
`r if (params$country != rp_full) ":::: {.content-hidden}"`
```{r chart_level2_saf_smi_per_state_ses, eval= (params$country == rp_full)}
...
::::: {.chart-container}  
```{r table_level2_saf_autotools, eval= (params$country != rp_full)}
