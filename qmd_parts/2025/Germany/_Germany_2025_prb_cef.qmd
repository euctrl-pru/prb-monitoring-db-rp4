...
-   DFS spent 90.7M€2022 in 2025 related to costs of investments for both en route and terminal charging zones, -18.0% less than determined (110.6M€2022). According to the NSA, this reduction was mainly due to "interest income from temporarily invested fixed deposits" and changes in some projects.

-   The en route actual unit cost incurred by users in 2025 was 77.90€ (-0.7% below the 2025 DUC), while the terminal actual unit cost incurred by users was 260.38€ (-6.1% below the 2025 DUC). The difference between the AUCU and the DUC for the terminal charging zone is mainly driven by the application of lower unit rate.
