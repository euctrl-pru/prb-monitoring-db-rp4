...
```{r chart_level2_saf_eosm_ses_allstates, eval=(year_folder != 'rp3')}
...
```{r chart_level2_saf_ri_per_state_ses, eval=(year_folder != 'rp3')}
...
```{r table_level2_saf_ri_apt_ses, eval=(year_folder != 'rp3')}
#| file: R/table_level2_saf_ri_apt_ses.R
#| include: false
```


``` {r table_level2_saf_ri_apt_ses_p, eval=(year_folder != 'rp3')}
#| echo: false
#| results: asis
...
```{r chart_level2_saf_smi_per_state_ses, eval=(year_folder != 'rp3')}
...
``` {r table_level2_saf_smi_ansp_pdf1_p, eval=(year_folder != 'rp3')}
#| echo: false
#| results: asis
...
```{r table_kea_summary, eval=(year_folder != 'rp3')}
#| file: R/table_env_kea_all_states.R
#| include: false
```

``` {r table_kea_summary_p, eval=(year_folder != 'rp3')}
#| echo: false
#| results: asis
...
```{r table_cap_erdelay_summary, eval=(year_folder != 'rp3')}
#| file: R/table_cap_erdelay_all_states.R
#| include: false
```


``` {r table_cap_erdelay_summary_p, eval=(year_folder != 'rp3')}
#| echo: false
#| results: asis
cat(make_quarto_latex_table(
...
```{r table_cap_arrdelay_summary, eval=(year_folder != 'rp3')}
#| file: R/table_cap_arrdelay_all_states.R
#| include: false
```


``` {r table_cap_arrdelay_summary_p, eval=(year_folder != 'rp3')}
#| echo: false
#| results: asis
cat(make_quarto_latex_table(
...
```{r chart_cap_all_causes_delay_ses, eval=(year_folder != 'rp3')}
...
```{r chart_cef_cost, options = (cz=c("1", "enroute")), eval=(year_folder != 'rp3')}
...
```{r table_cef_cost, options = (cz=c("1", "enroute")), eval=(year_folder != 'rp3')}
#| file: R/table_level2_cef_cost.R
#| include: false
```

``` {r table_cef_cost_p, eval=(year_folder != 'rp3')}
#| echo: false
#| results: asis
cat(make_quarto_latex_table(
...
:::: {#table-cef-summary}
```{r table_cef_summary, options = (cztype="enroute"), eval=(year_folder != 'rp3')}
...
```{r chart_cef_aucu_enroute, options = (cz=c("1", "enroute")), eval=(year_folder != 'rp3')}
...
```{r table_level2_cef_aucu_enroute, options = (cz=c("1", "enroute")), eval=(year_folder != 'rp3')}
#| file: R/table_level2_cef_aucu.R
#| include: false
```

``` {r table_level2_cef_aucu_enroute_p, eval=(year_folder != 'rp3')}
#| echo: false
#| results: asis
...
```{r chart_cef_cex_enroute, R.options = (cz=c("1", "enroute")), eval=(year_folder != 'rp3')}
...
```{r table_level2_cef_cex_enroute, R.options = (cz=c("1", "enroute")), eval=(year_folder != 'rp3')}
#| file: R/table_level2_cef_cex.R
#| include: false
```

``` {r table_level2_cef_cex_enroute_p, eval=(year_folder != 'rp3')}
#| echo: false
#| results: asis
