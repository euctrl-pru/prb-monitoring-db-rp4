...
```{r table_level2_env_apt_pis, eval=!(params$no_tcz == 0 | params$country == rp_full)}
#| file: R/table_level2_env_apt_pis.R
#| include: false
```


``` {r, eval=!(params$no_tcz == 0 | params$country == rp_full), include=(!(params$no_tcz == 0 | params$country == rp_full)}
#| echo: false
#| results: asis
