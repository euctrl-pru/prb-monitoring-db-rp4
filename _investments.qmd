...
## Value of the assets for New Investments included in the Performance Plan `r country` | `r if_else(params$country == rp_full, "all ANSPs", main_ansp)`
...
`r if (params$country == rp_full) "::: {.content-hidden}"`

### Asset value for new investments: ANSP compared to Union-wide

::: {layout="[ 33, 33, 33 ]"}
:::: {.chart-container}
```{r chart_invest_av_vs_eu1, eval=(params$country != rp_full)}
...
:::: {.chart-container}
```{r chart_invest_av_vs_eu2, eval=(params$country != rp_full)}
...
:::: {.chart-container}
```{r chart_invest_av_vs_eu3, eval=(params$country != rp_full)}
...
`r if (params$country == rp_full) ":::"`


`r if (params$country != rp_full) "::: {.content-hidden}"`

```{r chart_invest_av_state_type, eval=(params$country == rp_full)}
...
## Costs related to investments included in the Performance Plan `r country` | `r if_else(params$country == rp_full, "all ANSPs", main_ansp)`
...
```{r chart_invest_cost_state, eval=(params$country == rp_full)}
...
:::: {.chart-container}  
```{r chart_invest_difference_cost_er, eval=(params$country != rp_full), options= (cost_type = "en route")}
...
`r if (params$country != rp_full) "::: {.content-hidden}"`
```{r chart_invest_difference_cost_country_e, eval=(params$country == rp_full), options= (cost_type = "en route")}
...
`r if (params$no_tcz == 0 & params$country != rp_full) "::: {.content-hidden}"`

### Costs of investments by nature - Terminal

```{r, eval=(params$no_tcz != 0 | params$country == rp_full), options= (cost_type = "terminal")}
...
```{r, eval=(params$no_tcz != 0 | params$country == rp_full)}
#| echo: false
table2
```
...
:::: {.chart-container}  
```{r chart_invest_difference_cost_trm, eval=(params$no_tcz != 0 & params$country != rp_full), options= (cost_type = "terminal")}
#| file: R/chart_invest_difference_cost.R
#| out.width: "100%"
```
::::
...
`r if (params$no_tcz == 0 & params$country != rp_full) ":::"`


`r if (params$country != rp_full) "::: {.content-hidden}"`
```{r chart_invest_difference_cost_country_t, eval=(params$country == rp_full), options= (cost_type = "terminal")}
#| file: R/chart_invest_difference_cost_country.R
#| out.width: "100%"
```
`r if (params$country != rp_full) ":::"`
...
## Expected benefit and impact per new major investment `r country` | `r if_else(params$country == rp_full, "all ANSPs", main_ansp)`

`r if (params$country == rp_full) "::: {.content-hidden}"`

```{r table_invest_benefits_kpa, eval=!(params$country == rp_full)}
#| file: R/table_invest_benefits_kpa.R
#| out.width: "100%"
```

```{r table_invest_benefits, eval=!(params$country == rp_full)}
...
```{r table_invest_benefits_kpa_ses, eval=(params$country == rp_full)}
#| file: R/table_invest_benefits_kpa_ses.R
#| out.width: "100%"
```

```{r table_invest_impact_ses, eval=(params$country == rp_full)}
...
```{r table_invest_type, eval=!(params$country == rp_full)}
